...
class About_The_Author(object):
    ...
    def setupUi(self, AuthorWindow):
        ...
        self.menubar = QtWidgets.QMenuBar(AuthorWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 541, 21))
        self.menubar.setObjectName("menubar")
        AuthorWindow.setMenuBar(self.menubar)
    ...
    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("AuthorWindow", "AuthorWindow"))
        self.label.setText(_translate("AuthorWindow", "My name is craig"))
