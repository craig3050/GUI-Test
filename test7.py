...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_to_clear_list = QtWidgets.QPushButton(self.centralwidget)
        self.button_to_clear_list.setGeometry(QtCore.QRect(30, 160, 271, 41))
        self.button_to_clear_list.setObjectName("button_to_clear_list")
        ...
        self.button_to_clear_list.clicked.connect(self.pressed2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_to_clear_list.setText(_translate("MainWindow", "Press button to clear the list"))
